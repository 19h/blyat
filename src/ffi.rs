...
pub type ULChangeTitleCallback =
    ::std::option::Option<unsafe extern "C" fn(caller: ULView, title: ULString)>;
extern "C" {
    #[doc = " Set callback for when the page title changes"]
    pub fn ulViewSetChangeTitleCallback(view: ULView, callback: ULChangeTitleCallback);
}
pub type ULChangeURLCallback =
    ::std::option::Option<unsafe extern "C" fn(caller: ULView, url: ULString)>;
extern "C" {
    #[doc = " Set callback for when the page URL changes"]
    pub fn ulViewSetChangeURLCallback(view: ULView, callback: ULChangeURLCallback);
}
pub type ULChangeTooltipCallback =
    ::std::option::Option<unsafe extern "C" fn(caller: ULView, tooltip: ULString)>;
extern "C" {
    #[doc = " Set callback for when the tooltip changes (usually as result of a mouse hover)"]
    pub fn ulViewSetChangeTooltipCallback(view: ULView, callback: ULChangeTooltipCallback);
}
pub type ULChangeCursorCallback =
    ::std::option::Option<unsafe extern "C" fn(caller: ULView, cursor: ULCursor)>;
extern "C" {
    #[doc = " Set callback for when the mouse cursor changes"]
    pub fn ulViewSetChangeCursorCallback(view: ULView, callback: ULChangeCursorCallback);
}
...
extern "C" {
    ...
    pub fn ulViewSetAddConsoleMessageCallback(view: ULView, callback: ULAddConsoleMessageCallback);
}
pub type ULBeginLoadingCallback = ::std::option::Option<unsafe extern "C" fn(caller: ULView)>;
extern "C" {
    #[doc = " Set callback for when the page begins loading new URL into main frame"]
    pub fn ulViewSetBeginLoadingCallback(view: ULView, callback: ULBeginLoadingCallback);
}
pub type ULFinishLoadingCallback = ::std::option::Option<unsafe extern "C" fn(caller: ULView)>;
extern "C" {
    #[doc = " Set callback for when the page finishes loading URL into main frame"]
    pub fn ulViewSetFinishLoadingCallback(view: ULView, callback: ULFinishLoadingCallback);
}
pub type ULUpdateHistoryCallback = ::std::option::Option<unsafe extern "C" fn(caller: ULView)>;
extern "C" {
    #[doc = " Set callback for when the history (back/forward state) is modified"]
    pub fn ulViewSetUpdateHistoryCallback(view: ULView, callback: ULUpdateHistoryCallback);
}
pub type ULDOMReadyCallback = ::std::option::Option<unsafe extern "C" fn(caller: ULView)>;
extern "C" {
    ...
    pub fn ulViewSetDOMReadyCallback(view: ULView, callback: ULDOMReadyCallback);
}
extern "C" {
